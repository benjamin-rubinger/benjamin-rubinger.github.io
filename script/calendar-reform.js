...
function generateDatetimeInputs(index) {
    const $inputDate = $('<input onchange="updateDatetimeEvent">').attr('id', `input-date${index}`).addClass('input-date').attr('type', 'date');
    const $inputTime = $('<input onchange="updateDatetimeEvent">').attr('id', `input-time${index}`).addClass('input-time').attr('type', 'time'); //.attr('step', '1');
    ...
    const $selectTimezone = $('<select onchange="updateDatetimeEvent">').attr('id', `select-timezone${index}`).addClass('timezone');
